...
WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_First_Last_Name'), 'donald')

WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_ZIP_code'), '888888')

WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_Username'), 'balmasag@gmail.com')
