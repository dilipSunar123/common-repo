...
options.setExperimentalOption('prefs', new Script658561446160200$1())
...
WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_Username'), 'luckyy@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Profile_Creation_Page/Profile_Creation_Page_Objects/p_Greetings, Im Thomas Jackson, companion view profile text'), 
    0)
